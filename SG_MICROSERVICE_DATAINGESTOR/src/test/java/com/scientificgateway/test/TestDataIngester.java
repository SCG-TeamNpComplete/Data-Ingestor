package com.scientificgateway.test;
...
public class TestDataIngester {
	...
	public void returnRequiredObjects() {
		...
		target = client
				.target("http://ec2-35-161-48-143.us-west-2.compute.amazonaws.com:8085/SG_MICROSERVICE_DATAINGESTOR/webapi")
